...
switch(choice)
{
	...
	case 3:
		...
		cout<<"\n\n		1)scan every website on server for admin page (this may take some time depending upon number of websites on server and your net connection speed)";
		cout<<"\n\n		2)scan selected number of websites (from site number this to site number that)";
